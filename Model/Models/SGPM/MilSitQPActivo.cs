...
namespace Model.Models.SGPM
{
    ...
    public partial class MilSitQPActivo
    {
        // [ForeignKey("Artigo")]
        [Key]
        public string milSitQPActivoStamp { get; set; }
        public int codMilSitQPActivo { get; set; }
        public string situacaoQpAtivo { get; set; }
        public string numOS { get; set; }
        public string dataOS { get; set; }
        public string localFuncao { get; set; }
